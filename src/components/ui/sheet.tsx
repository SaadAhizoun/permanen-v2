...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-gradient-to-b from-elevated to-elevated/95 text-elevated-foreground p-6 shadow-lg transition ease-standard data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:duration-component data-[state=closed]:duration-micro",
  {
    variants: {
      side: {
